...
const navItems = [
  ...
  { href: "/timer", label: "Study Timer", icon: "clock" },
    ...
    <aside className="w-64 bg-surface border-r border-border flex flex-col h-full shrink-0">
      ...
      <div className="p-5 border-b border-border">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-lg font-bold text-foreground">StudyBoard</h1>
      ...
      <div className="p-3 border-t border-border space-y-0.5">
        ...
        {!isMidnight && (
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-foreground hover:bg-surface-hover transition-all duration-150 w-full cursor-pointer"
          >
            {darkMode ? (
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
